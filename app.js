...
let isAdultPresent = devs.some(devs => currentYear - devs.year >= 18)
...
let isEveryone19OrOlder = devs.every(devs => currentYear - devs.year >= 19)
...
let idx = comments.findIndex(comments => comments.id === 123523)
